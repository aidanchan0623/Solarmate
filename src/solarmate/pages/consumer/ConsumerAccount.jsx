    ...
    <div className="page-stack">
      <DashboardCard eyebrow="Account" title="Profile and Package">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
          <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-gradient-to-br from-teal-50/60 via-white/80 to-emerald-50/40 p-6 md:p-8 lg:col-span-2 shadow-sm backdrop-blur-md">
            <div className="pointer-events-none absolute -left-10 -top-10 h-40 w-40 rounded-full bg-teal-200/30 blur-3xl" />
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/80 bg-gradient-to-br from-amber-50/60 via-white/80 to-orange-50/30 p-6 md:p-8 lg:col-span-1 shadow-sm backdrop-blur-md">
            <div className="pointer-events-none absolute -right-10 -bottom-10 h-40 w-40 rounded-full bg-amber-200/30 blur-3xl" />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-4 mt-2 px-4 pb-2">
                <button className="primary-button shadow-[0_0_20px_rgba(245,158,11,0.2)] bg-gradient-to-br from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 border-none text-white transition-all hover:shadow-md hover:-translate-y-0.5" onClick={() => setIsChanging((current) => !current)} type="button">
                  Change Package
                </button>
